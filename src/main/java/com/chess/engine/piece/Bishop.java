...
public class Bishop extends Piece {
    ...
    public Bishop(final Coordiantes coordiantes, final Alliance alliance, final boolean isFirstMove) {
        super(PieceType.BISHOP, coordiantes, alliance, isFirstMove);
    }

    @Override
    public Piece movePiece(final Move move) {
        return new Bishop(move.getDestinationCoordinates(), move.getMovedPiece().getAlliance(), false);
    }
